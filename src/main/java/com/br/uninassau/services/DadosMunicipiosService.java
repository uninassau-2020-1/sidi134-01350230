...
public class DadosMunicipiosService {
	...
	public DadosMunicipiosDto findAll() {
		...
		dadosMunicipiosDto.setPercentualDomiciliosParticularesDesocupados(percentualDomiciliosParticularesDesocupados(retorno));
	...
	private double percentualDomiciliosParticularesDesocupados(List<DadosMunicipios> lista) {
		Long naoOcupados = totalDomiciliosParticularesNaoOcupados(lista);
		Long Ocupados = totalDomiciliosParticularesOcupados(lista);
		
		double percentual = ((double) naoOcupados/(double) Ocupados) * 100;
